...
%prep
%setup -q -n azure-core-1.24.1
cd %{_builddir}/azure-core-1.24.1
pushd ..
cp -a azure-core-1.24.1 buildavx2
popd
...
cp %{_builddir}/azure-core-1.24.1/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_core/5d941660d20397d61e58adb87e2dd05fa60828ef
