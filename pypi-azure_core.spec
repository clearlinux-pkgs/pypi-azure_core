...
Source0  : https://files.pythonhosted.org/packages/f2/b0/334c52e5bee1c46aec7a1b62739be6ea9c19ace38f54ca4510d45398071d/azure-core-1.24.0.zip
...
%prep
%setup -q -n azure-core-1.24.0
cd %{_builddir}/azure-core-1.24.0
pushd ..
cp -a azure-core-1.24.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1653004109
...
cp %{_builddir}/azure-core-1.24.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_core/5d941660d20397d61e58adb87e2dd05fa60828ef
