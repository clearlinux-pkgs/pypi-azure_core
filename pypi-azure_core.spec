...
Source0  : https://files.pythonhosted.org/packages/cc/c3/b60ac8b63a6f8982cbdab64cb1bd3d9ab036bff5756f4ea74199d80a186c/azure-core-1.29.7.tar.gz
...
%prep
%setup -q -n azure-core-1.29.7
cd %{_builddir}/azure-core-1.29.7
pushd ..
cp -a azure-core-1.29.7 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1705701686
