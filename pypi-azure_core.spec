...
Source0  : https://files.pythonhosted.org/packages/4f/ec/3ba46ff4deebe738b7213997fc856553282e971a767b6291e05aca9d9566/azure-core-1.26.1.zip
...
%prep
%setup -q -n azure-core-1.26.1
cd %{_builddir}/azure-core-1.26.1
pushd ..
cp -a azure-core-1.26.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672257557
