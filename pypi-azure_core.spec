...
Source0  : https://files.pythonhosted.org/packages/03/7a/f79ad135a276a37e61168495697c14ba1721a52c3eab4dae2941929c79f8/azure_core-1.31.0.tar.gz
...
%prep
%setup -q -n azure_core-1.31.0
cd %{_builddir}/azure_core-1.31.0
pushd ..
cp -a azure_core-1.31.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1726238109
...
cp %{_builddir}/azure_core-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_core/5d941660d20397d61e58adb87e2dd05fa60828ef || :
