...
Source0  : https://files.pythonhosted.org/packages/75/aa/7c9db8edd626f1a7d99d09ef7926f6f4fb34d5f9fa00dc394afdfe8e2a80/azure_core-1.33.0.tar.gz
...
%prep
%setup -q -n azure_core-1.33.0
cd %{_builddir}/azure_core-1.33.0
pushd ..
cp -a azure_core-1.33.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1743781677
...
cp %{_builddir}/azure_core-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_core/7aea571d641549de89730da8e7ff5a6940c5526b || :
...
/usr/share/package-licenses/pypi-azure_core/7aea571d641549de89730da8e7ff5a6940c5526b
