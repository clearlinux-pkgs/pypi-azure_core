...
Source0  : https://files.pythonhosted.org/packages/0e/53/8983f401b153a5d8482880b3155cac7d8f313a3c69a01fdb4442f635fc1a/azure-core-1.26.3.zip
...
%prep
%setup -q -n azure-core-1.26.3
cd %{_builddir}/azure-core-1.26.3
pushd ..
cp -a azure-core-1.26.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1675384253
