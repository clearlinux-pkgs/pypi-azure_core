...
Source0  : https://files.pythonhosted.org/packages/99/d4/1f469fa246f554b86fb5cebc30eef1b2a38b7af7a2c2791bce0a4c6e4604/azure-core-1.30.2.tar.gz
...
%prep
%setup -q -n azure-core-1.30.2
cd %{_builddir}/azure-core-1.30.2
pushd ..
cp -a azure-core-1.30.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717714208
