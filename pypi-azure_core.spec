...
Source0  : https://files.pythonhosted.org/packages/5c/ab/07831a8b88a048a6311cd8ebe6296c089f673a473212f17766ff5edee28d/azure-core-1.24.2.zip
...
%prep
%setup -q -n azure-core-1.24.2
cd %{_builddir}/azure-core-1.24.2
pushd ..
cp -a azure-core-1.24.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1656621084
...
cp %{_builddir}/azure-core-1.24.2/LICENSE %{buildroot}/usr/share/package-licenses/pypi-azure_core/5d941660d20397d61e58adb87e2dd05fa60828ef
