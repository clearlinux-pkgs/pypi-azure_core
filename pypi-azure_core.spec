...
Source0  : https://files.pythonhosted.org/packages/b1/38/ecb085532b46ca3893732d2dafa8b75a1754164b1c0e757e7c53c4250714/azure-core-1.30.0.tar.gz
...
%prep
%setup -q -n azure-core-1.30.0
cd %{_builddir}/azure-core-1.30.0
pushd ..
cp -a azure-core-1.30.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1706891947
