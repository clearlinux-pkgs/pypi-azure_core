...
Source0  : https://files.pythonhosted.org/packages/51/0d/b76383f028aa3570419edf97ab504cb84b839e3cbc8c8b2048f16bbea2d3/azure-core-1.30.1.tar.gz
...
%prep
%setup -q -n azure-core-1.30.1
cd %{_builddir}/azure-core-1.30.1
pushd ..
cp -a azure-core-1.30.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1709323849
