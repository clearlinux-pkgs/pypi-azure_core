...
Source0  : https://files.pythonhosted.org/packages/ee/ab/05f2bf8699aad4c3eb29c1702cc1784c106816cc07bf8ac43abad9496a9d/azure-core-1.26.0.zip
...
%prep
%setup -q -n azure-core-1.26.0
cd %{_builddir}/azure-core-1.26.0
pushd ..
cp -a azure-core-1.26.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1665152707
