...
Source0  : https://files.pythonhosted.org/packages/ce/89/f53968635b1b2e53e4aad2dd641488929fef4ca9dfb0b97927fa7697ddf3/azure_core-1.35.0.tar.gz
...
%prep
%setup -q -n azure_core-1.35.0
cd %{_builddir}/azure_core-1.35.0
pushd ..
cp -a azure_core-1.35.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1751550611
