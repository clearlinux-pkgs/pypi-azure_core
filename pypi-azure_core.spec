...
Source0  : https://files.pythonhosted.org/packages/05/71/21dd6d5f227a5d82b869068a0b652b26edc9efb86c7a5139740a0ffeb775/azure-core-1.26.2.zip
...
%prep
%setup -q -n azure-core-1.26.2
cd %{_builddir}/azure-core-1.26.2
pushd ..
cp -a azure-core-1.26.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1672968685
