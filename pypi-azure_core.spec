...
Source0  : https://files.pythonhosted.org/packages/e3/39/328faea9f656075dbb8ecf70f1a4697bc80510fcc70e3e8f0090c34fc00c/azure-core-1.29.5.tar.gz
...
%prep
%setup -q -n azure-core-1.29.5
cd %{_builddir}/azure-core-1.29.5
pushd ..
cp -a azure-core-1.29.5 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1697824536
