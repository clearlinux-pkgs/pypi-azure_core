...
Source0  : https://files.pythonhosted.org/packages/c9/29/ff7a519a315e41c85bab92a7478c6acd1cf0b14353139a08caee4c691f77/azure_core-1.34.0.tar.gz
...
%prep
%setup -q -n azure_core-1.34.0
cd %{_builddir}/azure_core-1.34.0
pushd ..
cp -a azure_core-1.34.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1746195987
